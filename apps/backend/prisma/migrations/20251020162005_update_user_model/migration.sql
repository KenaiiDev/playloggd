...
INSERT INTO "new_User" ("avatarUrl", "bio", "createdAt", "email", "id", "passwordHash", "updatedAt", "username") SELECT "avatarUrl", "bio", "createdAt", "email", "id", "passwordHash", "updatedAt", "username" FROM "User";
DROP TABLE "User";
